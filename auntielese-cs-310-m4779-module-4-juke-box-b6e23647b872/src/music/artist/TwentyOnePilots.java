...
public class TwentyOnePilots {
    ...
    public ArrayList<Song> getTwentyOnePilotsSongs() {
    	 ...
    	 Song track1 = new Song("Chlorine", "Twenty One Pilots");             //Create a song
         Song track2 = new Song("Heavy Dirty Soul", "Twenty One Pilots");         //Create another song
         Song track3 = new Song("Holding on to You", "Twenty One Pilots");
